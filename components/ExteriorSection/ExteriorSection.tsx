...
const ExteriorSection = () => {
	...
	return (
		<section className="max-w-7xl mx-auto p-14">
			<h2
				className="text-base leading-5 uppercase text-gray-100 font-CodecPro500 md:text-2xl lg:leading-6"
				data-aos="fade-right"
							...
							<div className={`flex flex-col gap-4 lg:py-10 md:w-4/5`}>
								{block.sections.map((section) => (
									<div key={section.key} className="flex flex-col sm:flex-row">
										...
										<p
											className={`${contentStyle} w-full ${
												block.key !== "foundation" && "sm:w-1/3"
											}`}
										>
